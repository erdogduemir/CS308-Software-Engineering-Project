            ...
            <MDBCard className="mb-4">
              ...
              <MDBCardBody>
                <MDBRow>
                  <MDBCol lg="3" md="12" className="mb-4 mb-lg-0">
                    <MDBRipple rippleTag="div" rippleColor="light"
                      ...
                      <img
                        src="https://cdn.wheel-size.com/automobile/body/mercedes-g-class-2018-2023-1653972031.9369192.jpg"
                        className="w-100" />
                      <a href="#!">
                  ...
                  <MDBCol lg="5" md="6" className=" mb-4 mb-lg-0">
                    <p>
                      <strong>Mercedes-Benz G-Class G500</strong>
                    </p>
                    <p>Color: Black </p>
                    <p>Type: SUV</p>
                ...
                <MDBRow>
                  ...
                  <MDBCol lg="5" md="6" className=" mb-4 mb-lg-0">
                    <p>
                      <strong>Ferrari La Ferrari</strong>
                    </p>
                    <p>Color: Red</p>
                    <p>Type: Exotic</p>
